...
// Output: 54esmdr0qf
$firstcode = substr(str_shuffle($permitted_chars), 0, 2);
 
$permitted_chars = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
// Output: video-g6swmAP8X5VG4jCi.mp4
$maincode = 'q'.substr(str_shuffle($permitted_chars), 0, 10);
$maincode = strtoupper($maincode); 
return $maincode;
}
...
mysqli_query($conn,"INSERT INTO activitylog (username, message, ipaddress, refferer, pagevisited, useragent, timestamp) VALUES ('$username', '$logmsg', '$ipaddress', '$refferer', '$pagevisited', '$useragent', NOW())") or die(mysqli_error($conn)." Log Failed");	
